 ...
 */
public class DataPrintLorryActivity extends Activity implements DataPrintLorryFragment.DataPrintCallback {
    private String clientId;
    private String testNo;
    private ProgressDialog dialog;
    private LorryDataItem referData;
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    Toast.makeText(DataPrintLorryActivity.this, R.string.tip_data_printing, Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    fragmentCommit();
                    break;
    ...
    private void fragmentCommit() {
        DataPrintLorryFragment fragment = new DataPrintLorryFragment();
        fragment.setSaveBtnVisible(View.GONE);
        fragment.setConnect(false);
        fragment.setLorryData(referData);
    ...
    class QueryThread extends Thread {
        ...
        @Override
        public void run() {
            referData = new CustomDbUtil().queryLorryTestData(clientId, testNo);
